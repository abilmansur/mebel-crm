...
export const demoInbox: InboxMessage[] = [
  { id: "i1", channel: "whatsapp", chat_id: null, direction: "in", read: false, client_name: "Ержан Т.", text: "Здравствуйте, сколько будет стоить шкаф-купе 2 на 2.5 метра?", ai_suggestion: "Ориентировочно от 65 000 за ЛДСП 16мм с учётом кромки. Уточните материал для точного расчёта?" },
  { id: "i2", channel: "telegram", chat_id: null, direction: "in", read: false, client_name: "Наталья К.", text: "Когда будет готов мой кухонный гарнитур?", ai_suggestion: "Заказ «Кухонный гарнитур» сейчас в производстве, ожидаемая готовность через 4 дня." },
  { id: "i3", channel: "phone", chat_id: null, direction: "in", read: false, client_name: "Бекзат А.", text: "Звонок 09:41 — интересовался прихожей на заказ, оставил номер", ai_suggestion: "Предложить замер на дом в ближайшие 2 дня, отправить примеры из портфолио." },
  { id: "i4", channel: "site", chat_id: null, direction: "in", read: false, client_name: "Форма с сайта", text: "Гардеробная система, площадь комнаты 8м², нужен расчёт", ai_suggestion: "Запросить точные габариты ниши и предпочитаемый материал перед расчётом сметы." },
];
