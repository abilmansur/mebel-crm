...
const dict: Record<string, Record<Lang, string>> = {
  ...
  "ai.test": { ru: "Проверить, что ИИ отвечает", kk: "ИИ жауап беретінін тексеру", en: "Test that the AI replies" },
  "ai.testing": { ru: "Проверяем…", kk: "Тексерілуде…", en: "Testing…" },
  "ai.testNetworkError": { ru: "Не удалось связаться с сервером.", kk: "Серверге қосылу мүмкін болмады.", en: "Couldn't reach the server." },
  "ai.provider": { ru: "Провайдер ИИ", kk: "ИИ провайдері", en: "AI provider" },

  "balance.title": { ru: "Баланс", kk: "Баланс", en: "Balance" },
  "balance.current": { ru: "Текущий баланс", kk: "Ағымдағы баланс", en: "Current balance" },
  "balance.lowWarning": {
  ...
  "balance.processing": { ru: "Обрабатываем платёж…", kk: "Төлем өңделуде…", en: "Processing payment…" },
  "balance.topupDescription": { ru: "Пополнение баланса ИИ-ассистента", kk: "ИИ-ассистент балансын толықтыру", en: "AI assistant balance top-up" },
  "balance.paymentFailed": { ru: "Платёж не прошёл. Попробуй ещё раз.", kk: "Төлем өтпеді. Қайталап көріңіз.", en: "Payment failed. Please try again." },
  "balance.widgetLoadError": { ru: "Не удалось загрузить форму оплаты.", kk: "Төлем формасы жүктелмеді.", en: "Couldn't load the payment form." },
  "balance.notConfigured": {
    ru: "Оплата картой ещё не настроена разработчиком.",
    kk: "Картамен төлеу әлі теңшелмеген.",
    en: "Card payment isn't configured yet.",
  },
